...
description: "Generate 50+ page professional market research reports with consulting-firm quality (McKinsey, BCG, Gartner style). Includes Porter's Five Forces, PESTLE, SWOT, TAM/SAM/SOM analysis, extensive visualizations, and LaTeX formatting. Use for competitive landscape analysis, market sizing, investment due diligence, and strategic planning. Integrates with research-lookup for data gathering and scientific-schematics for visualization generation."
allowed-tools: [Read, Write, Edit, Bash]
compatibility: Requires research-lookup, scientific-schematics, generate-image, peer-review, citation-management skills
---
