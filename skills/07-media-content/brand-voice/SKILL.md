---
name: brand-voice
description: Build a source-derived writing style profile from real posts, essays, launch notes, docs, or site copy, then reuse across content, outreach, social workflows. Use BEFORE content-creation workflows to inject voice consistency. Triggers: user mentions specific author/brand voice, requests consistency across channels, wants to avoid generic AI patterns, asks for outbound writing, or any multi-turn content session.
origin: ECC
---
