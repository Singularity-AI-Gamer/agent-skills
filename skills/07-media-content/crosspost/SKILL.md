---
name: crosspost
description: Multi-platform content distribution across X, LinkedIn, Threads, and Bluesky. Adapts content per platform using content-engine patterns. Never posts identical content cross-platform. Use whenever the user mentions crossposting, distributing content across platforms, adapting a post for multiple social accounts, or publishing on X/LinkedIn/Threads/Bluesky — even if they don't explicitly say "crosspost".
origin: ECC
---
...
- a draft post or article the user provides inline
- a URL the user shares (fetch and summarize before adapting)
- a launch note, thread, memo, or changelog excerpt
...
- a brief rationale per platform, formatted as:
     `[Platform]: what was adapted and why (1–2 sentences)`
