...
description: Use this skill whenever you need to retrieve Jira tickets, analyze requirements, update ticket status, add comments, or transition issues. Always consult this skill when working on a feature branch tied to a Jira issue, extracting acceptance criteria, or updating progress in Jira. Provides both MCP-based (recommended) and direct REST API approaches.
origin: ECC
compatibility: "Python 3.10+, uvx (uv), environment variables: JIRA_URL, JIRA_EMAIL, JIRA_API_TOKEN"
---
