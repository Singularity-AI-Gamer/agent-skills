---
name: github-ops
description: GitHub repository operations, automation, and management. Issue triage, PR management, CI/CD operations, release management, and security monitoring using the gh CLI. Use this skill WHENEVER the user mentions GitHub, issues, pull requests, CI failures, releases, contributors, repository health, Dependabot alerts, secret scanning, workflow debugging, stale PRs, or any GitHub operational task beyond simple git commands — even if they don't explicitly ask for automation.
origin: ECC
---
