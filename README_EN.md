...
|---|---:|---|---|
| <img src="assets/README/icons/overview.svg" width="20" alt=""> Agent Engineering | 9 | `skills/01-agent-engineering/` | Agent building, debugging, autonomy loops, skill creation, GPT-6 Pro plan review, adaptive quality gates, adversarial verification, and skill lifecycle management. |
...
| <img src="assets/README/icons/format.svg" width="20" alt=""> Media and Content | 19 | `skills/07-media-content/` | PPT, PDF, DOCX, XLSX, images, video, WeChat articles, and presentation content. |
