...
共 244 个技能，按 12 个能力域 + projects（项目私有）分组。

## 目录

- [01 Agent 工程](#01-agent-工程)（58）
- [02 编程语言](#02-编程语言)（37）
- [03 框架与技术栈](#03-框架与技术栈)（24）
- [04 测试与质量](#04-测试与质量)（12）
- [05 DevOps 与基础设施](#05-devops-与基础设施)（4）
- [06 数据与检索](#06-数据与检索)（11）
- [07 媒体与内容制作](#07-媒体与内容制作)（17）
- [08 写作与营销](#08-写作与营销)（12）
- [09 办公自动化与协作](#09-办公自动化与协作)（38）
- [10 行业与业务](#10-行业与业务)（14）
- [11 Web3 与区块链](#11-web3-与区块链)（3）
...
具体框架/技术栈：Django、Laravel、Spring Boot、Next.js、Flutter 等。
...
E2E、TDD、代码审查、质量门禁、playwright、eval-harness、安全审查。
...
PPT、视频、PDF、Excel、Word、图像、音乐生成、UI/UX 设计。
...
飞书、Google Workspace、Slack、邮件、终端、GitHub、Jira 等工作面板。
...
医疗、金融、物流、供应链、采购、法律、能源、库存、生产等垂直场景。
...
Claude API、LLM 管线、Token 预算、Foundation Models。
