...
Skill-hub is a public Chinese-first AI Agent skill library for Codex, Claude Code, Antigravity, and related AI coding tools. It collects reusable `SKILL.md` automation practices, AI coding workflows, and prompt templates. The repository currently contains **23** reusable skills: **23** shared skills organized by capability domain and **0** project-specific skills archived by project for lookup, local sync, source tracking, and ongoing maintenance.
...
|---|---:|---|---|
| <img src="assets/README/icons/overview.svg" width="20" alt=""> Agent Engineering | 7 | `skills/01-agent-engineering/` | Agent building, debugging, autonomy loops, skill creation, Sol Pro plan review, quality gates, skill lifecycle management, and Windows disk/project/memory maintenance. |
...
```text
skills/                        # 23 shared skills, 5 capability domains
