...
Skill-hub is a public Chinese-first AI Agent skill library for Codex, Claude Code, Antigravity, and related AI coding tools. It collects reusable `SKILL.md` automation practices, AI coding workflows, and prompt templates. The repository currently contains **29** reusable skills: **29** shared skills organized by capability domain and **0** project-specific skills archived by project for lookup, local sync, source tracking, and ongoing maintenance.
...
|---|---:|---|---|
| <img src="assets/README/icons/overview.svg" width="20" alt=""> Agent Engineering | 6 | `skills/01-agent-engineering/` | Agent building, debugging, autonomy loops, skill creation, Sol Pro plan review, quality gates, skill lifecycle management, and Windows disk/project/memory maintenance. |
...
| <img src="assets/README/icons/index.svg" width="20" alt=""> Data and Search | 8 | `skills/06-data-search/` | Data scraping, search, deep research, PubMed, clinical trials, and report delivery. |
| <img src="assets/README/icons/format.svg" width="20" alt=""> Media and Content | 9 | `skills/07-media-content/` | PPT, PDF, DOCX, XLSX, images, video, GitHub README visuals, WeChat articles, and presentation content. |
| <img src="assets/README/icons/writing.svg" width="20" alt=""> Writing and Marketing | 1 | `skills/08-writing-marketing/` | Style imitation, marketing writing, GitHub SEO standards, and recurring evaluation. |
| <img src="assets/README/icons/source-index.svg" width="20" alt=""> Business and Industry | 3 | `skills/10-business-industry/` | Healthcare, legal, finance, market sizing, citation verification, pharma social listening, and industry report workflows. |
| <img src="assets/README/icons/directory.svg" width="20" alt=""> Project-Specific | 0 | `projects/` | Skills scoped to specific projects, such as email testing, Feishu, Alibaba Cloud, or invoice workflows. |

## <img src="assets/README/icons/directory.svg" width="20" alt=""> Directory Structure

```text
skills/                        # 29 shared skills, 6 capability domains
...
projects/                      # 0 project-specific skills
